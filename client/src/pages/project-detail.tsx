              ...
              <div className="ml-4">
                ...
                <div className="flex items-center mt-2 space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M17.732 7.222l-4.387 4.262-4.388-4.262-7.144 6.934 7.144 6.843 4.388-4.262 4.387 4.262 7.144-6.843-7.144-6.934zm4.167 6.934c0 .456-.194.883-.534 1.19l-6.054 5.797c-.338.324-.79.504-1.263.504-.474 0-.926-.173-1.264-.504l-6.053-5.797c-.338-.307-.532-.734-.532-1.19 0-.455.193-.882.532-1.19l6.053-5.797a1.901 1.901 0 012.527 0l6.054 5.797c.34.308.534.735.534 1.19z" />
                      </svg>
                    </a>
                  </div>
                </div>
