...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-[color:var(--color-black)] shadow-sm sticky top-0 z-10 border-b border-[color:var(--border-color)]">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-3">
            <Button
              ...
              className="rounded-full text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] hover:bg-[color:var(--color-gray-100)]"
            >
              {theme === 'dark' ? (
            ...
            {isAuthenticated ? (
              ...
              <>
                <Button 
                  ...
                  size="sm"
                  onClick={handleLogin}
                  className="font-['IBM_Plex_Mono'] text-sm font-medium px-6 py-2 bg-[color:var(--color-gray-100)] text-[color:var(--text-primary)] border-[color:var(--border-color)] hover:bg-[color:var(--color-gray-200)]"
                >
                  Log In
                </Button>
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <Button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] hover:bg-[color:var(--color-gray-100)]"
            >
      ...
      {/* Mobile menu */}
      {isMobileMenuOpen && (
        <div className="sm:hidden bg-[color:var(--background)] border-t border-[color:var(--border-color)] pt-2 pb-3">
            ...
            <Link 
              ...
              className={`block py-2 px-3 rounded-md font-['IBM_Plex_Mono'] text-base font-medium ${
                location === "/"
                  ...
                  : "text-[color:var(--text-primary)] hover:bg-[color:var(--color-gray-100)] hover:text-[color:var(--text-primary)]"
              }`}
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="mt-3 space-y-3">
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full font-['IBM_Plex_Mono'] text-sm flex items-center justify-center bg-[color:var(--color-gray-100)] text-[color:var(--text-primary)] border-[color:var(--border-color)] hover:bg-[color:var(--color-gray-200)]"
                    onClick={() => {
                      handleLogout();
              ...
              <div className="space-y-3">
                ...
                <Button 
                  variant="outline" 
                  className="w-full font-['IBM_Plex_Mono'] text-sm font-medium bg-[color:var(--color-gray-100)] text-[color:var(--text-primary)] border-[color:var(--border-color)] hover:bg-[color:var(--color-gray-200)]"
                  onClick={() => {
                    handleLogin();
                    setIsMobileMenuOpen(false);
                  }}
